    ...
    <div class="block-container">
        ...
        <div class="row" style="grid-template-columns: 1.28fr 1fr;">
            ...
            <div class="card summary-card">
                <h3><i class="fa-solid fa-chart-pie" style="color:#1B2559; margin-right:8px;"></i>Sales Summary</h3>
            ...
            <div class="card trend-card">
                <h3><i class="fa-solid fa-chart-line" style="color:#1B2559; margin-right:8px;"></i>Tren Penjualan</h3>
        ...
        <div class="row" style="grid-template-columns: 1fr 1.85fr;">
            ...
            <div class="col">
                <div class="card map-card" style="height: 33vh; margin-bottom: 15px;">
                    <h3><i class="fa-solid fa-earth-asia" style="color:#1B2559; margin-right:8px;"></i>Revenue per Province</h3>
                    <div id="mapChart" class="chart-container"></div>
                </div>
                <div class="card top-product-card" style="height: 25vh;">
                    <div style="margin-bottom: 5px;">
                        <div style="font-size: 16px; font-weight: 700; color: #001C3F; margin: 0;"><i class="fa-solid fa-trophy" style="color:#F59E0B; margin-right:8px;"></i>Top 10 Subproduct</div>
            ...
            <div class="col">
                <div class="card category-card" style="height: 29vh; margin-bottom: 15px;">
                    <h3><i class="fa-solid fa-bag-shopping" style="color:#1B2559; margin-right:8px;"></i>Revenue per Category</h3>
                    <div id="categoryChart" class="chart-container"></div>
                </div>
                <div class="card return-card" style="height: 29vh;">
                    <h3><i class="fa-solid fa-rotate-left" style="color:#1B2559; margin-right:8px;"></i>Return Analysis</h3>
